...
Function RefreshStrings()
	...
	Pages[0] = "$Overview"
	Pages[1] = "$Settings"
	Pages[2] = "$Milking_Configuration"
	Pages[3] = "$Milk_Market_Information"
	Pages[4] = "$Debug"
	...
	Preset = new string[3]
	Preset[0] = "$Preset_Hard"
	Preset[1] = "$Preset_Normal"
	Preset[2] = "$Preset_Easy"
	...
	RaceMilk[0] = "$RaceMilk_Nothing"
	RaceMilk[1] = "$RaceMilk_Altmer_Milk"
	RaceMilk[2] = "$RaceMilk_Argonian_Milk"
	RaceMilk[3] = "$RaceMilk_Bosmer_Milk"
	RaceMilk[4] = "$RaceMilk_Breton_Milk"
	RaceMilk[5] = "$RaceMilk_Dunmer_Milk"
	RaceMilk[6] = "$RaceMilk_Imperial_Milk"
	RaceMilk[7] = "$RaceMilk_Khajiit_Milk"
	RaceMilk[8] = "$RaceMilk_Nord_Milk"
	RaceMilk[9] = "$RaceMilk_Orc_Milk"
	RaceMilk[10] = "$RaceMilk_Redguard_Milk"
	RaceMilk[11] = "$RaceMilk_Exotic_Milk"		;Custom race
EndFunction
...
event OnPageReset(string page)
	...
	elseif page == "$Settings"
		self.Settings()
	elseif page == "$Milking_Configuration"
		self.Milking_Config()
	elseif page == "$Milk_Market_Information"
		self.Market()
	elseif page == "$Debug"
		self.Debug()
...
function Overview()
	...
	SetCursorFillMode(TOP_TO_BOTTOM)
		AddHeaderOption("$Overview_Progression_Info_Header")
			AddTextOption("$Maid_Mastery_Level", MilkLevel as int)
			if MilkLevel < 10
				AddTextOption("$Times_Milked_(this_level)", MilkQ.ProgressionTimesMilked as int)
			else
				AddTextOption("$Times_Milked_(this_level)", "--")
			endif
			if MilkLevel < 10
				AddTextOption("$Next_Level", ((MilkLevel as int + 1) * MilkQ.TimesMilkedMult as int) )
			else
				AddTextOption("$Next_Level", "MAX")
			endif	
			AddTextOption("$Times_Milked_(overall)", MilkQ.ProgressionTimesMilkedAll as int)
			AddTextOption("$Maid_Slots_Unlocked", MilkQ.Milklvl0fix())
	
	SetCursorPosition(1)
		AddHeaderOption("$Overview_Milk_Maids_Header")
			int i = 0
			While i < MilkQ.MilkMaid.Length
				if MilkQ.MilkMaid[i] != None
				MME_ActorAlias ActorAliasOverview = self.GetAlias(i) as MME_ActorAlias
					...
					AddTextOption("$Overview_Milkmaid_Level" , MaidLevel)
					AddTextOption("$Overview_Milkmaid_Times_Milked_(to_level)" , ActorAliasOverview.getTimesMilked() as int + " (" + ((MaidLevel + 1) * MilkQ.TimesMilkedMult as int)+ ")")
					AddTextOption("$Overview_Milkmaid_Lactacid" , MilkQ.ReduceFloat(MME_Storage.getLactacidCurrent(ActorAliasOverview)))
					AddTextOption("$Overview_Milkmaid_Milk" , MilkQ.ReduceFloat(MilkCnt) + " [" + MilkMax as int + "]")
					AddTextOption("$Overview_Milkmaid_Pain", MilkQ.NState(MilkQ.MilkMaid[i]) + " [" + (PainCnt/PainMax*100) as int + "%]")
					AddEmptyOption()
				endif
				i = i + 1
			endWhile
...
function Settings()
	SetCursorFillMode(TOP_TO_BOTTOM)
		AddHeaderOption("$Settings_H1")
			if MilkQ.MilkFlag
				AddTextOptionST("Mod_Status_T", "$Settings_H1_S1", "$Enabled")
			else
				AddTextOptionST("Mod_Status_T", "$Settings_H1_S1", "$Disabled")
			endif
			if MilkQ.EconFlag
				AddTextOptionST("Econ_Status_T", "$Settings_H1_S2", "$Enabled")
			else
				AddTextOptionST("Econ_Status_T", "$Settings_H1_S2", "$Disabled")
			endif
			AddSliderOptionST("Poll_Interval_Slider", "$Settings_H1_S2.1", MilkQ.MilkPoll, "$Settings_H1_S2.2")
			AddToggleOptionST("MaidLvlCap_Toggle", "$Settings_H1_S5", MilkQ.MaidLvlCap)
			if MilkQ.MilkQC.Buffs
				AddTextOptionST("Buff_Toggle", "$Settings_H1_S6", "$Enabled")
			else
				AddTextOptionST("Buff_Toggle", "$Settings_H1_S6", "$Disabled")
			endif
			AddSliderOptionST("MilkGenerationValue_Slider", "$Settings_H1_S7", MilkQ.MilkGenValue, "$Settings_H1_S7.1")
			...
			AddSliderOptionST("LactacidDecayRate_Slider", "$Settings_H1_S9", MilkQ.LactacidDecayRate, "{2}")
			AddSliderOptionST("LactacidMod_Slider", "$Settings_H1_S12", MilkQ.LactacidMod, "{2}")
			;AddToggleOptionST("Settings_WeightUpScale_Toggle", "$Settings_H1_S8", MilkQ.WeightUpScale)

		AddHeaderOption("$Settings_H2")
			if MilkQ.BreastScale == 3
				AddTextOptionST("BreastScale_Toggle", "$Settings_H2_S6", "OFF")
			else
				AddTextOptionST("BreastScale_Toggle", "$Settings_H2_S6", "ON")
			endif
			AddToggleOptionST("BellyScale_Toggle", "$Settings_H2_S8", MilkQ.BellyScale)
			AddToggleOptionST("BreastScaleLimit_Toggle", "$Settings_H2_S7", MilkQ.BreastScaleLimit)
			AddSliderOptionST("BreastScaleMax_Slider", "$Settings_H2_S1", MilkQ.BoobMAX, "{2}")
			AddSliderOptionST("BreastCurve_Slider", "$Settings_H2_S2", MilkQ.BreastCurve, "{2}")
			AddSliderOptionST("BreastIncrease_Slider", "$Settings_H2_S3", MilkQ.BoobIncr, "{2}")
			AddSliderOptionST("BreastIncreasePerLvl_Slider", "$Settings_H2_S4", MilkQ.BoobPerLvl, "{2}")
			AddToggleOptionST("BreastUpScale_Toggle", "$Settings_H2_S5", MilkQ.BreastUpScale)

		AddHeaderOption("$Settings_H3")
			AddToggleOptionST("Notification_Messages_Toggle", "$Settings_H3_S1", MilkQ.MilkMsgs)
			AddToggleOptionST("Milk_Count_Notification_Messages_Toggle", "$Settings_H3_S7", MilkQ.MilkCntMsgs)
			AddToggleOptionST("Notification_Economy_Messages_Toggle", "$Settings_H3_S6", MilkQ.MilkEMsgs)
			AddToggleOptionST("Milk_Stories_Toggle", "$Settings_H3_S2", MilkQ.MilkStory)
			AddSliderOptionST("NPCComments_Chance_Slider", "$Settings_H3_S3", MilkQ.MME_NPCComments.GetValue(), "{2}%")
			AddToggleOptionST("DialogueMilking_Toggle", "$Settings_H3_S4", MilkQ.MilkQC.MME_DialogueMilking)
			if MilkQ.MilkQC.Debug_enabled
				AddToggleOptionST("DialogueForceMilkSlave_Toggle", "$Settings_H3_S8", MilkQ.DialogueForceMilkSlave)
			endif
			AddKeyMapOptionST("Hotkey", "$Settings_H3_S5", MilkQ.NotificationKey)
;			if MilkQ.HotkeyMode == 1
;				AddTextOptionST("Hotkey_Toggle", "$Settings_H3_S9", "UI extension")
;			else
;				AddTextOptionST("Hotkey_Toggle", "$Settings_H3_S9", "Classic")
;			endif
		
	SetCursorPosition(1)
		AddHeaderOption("$Settings_H4")
...
function Milking_Config()
	SetCursorFillMode(TOP_TO_BOTTOM)
			AddToggleOptionST("SimpleMilk_Toggle", "$Milking_H3_S13", MilkQ.MilkQC.MME_SimpleMilkPotions)
			AddSliderOptionST("Milking_Duration_Slider", "$Milking_H3_S7.1", MilkQ.Milking_Duration, "$Milking_H3_S7.2")
			AddSliderOptionST("Milking_GushPct_Slider", "$Milking_H3_S16", MilkQ.GushPct, "{2}" + "%")
			if MilkQ.MilkNaked
				AddTextOptionST("Milking_MilkWithZaZMoMSuctionCups_Toggle", "$Milking_H3_S5", "$Milking_H3_S5.1")
			elseif MilkQ.MilkWithZaZMoMSuctionCups
				AddTextOptionST("Milking_MilkWithZaZMoMSuctionCups_Toggle", "$Milking_H3_S5", "$Milking_H3_S5.2")
			else
				AddTextOptionST("Milking_MilkWithZaZMoMSuctionCups_Toggle", "$Milking_H3_S5", "$Milking_H3_S5.3")
			endif
			AddToggleOptionST("FutaMilkCuirass_Toggle", "$Milking_H3_S17", MilkQ.UseFutaMilkCuirass)
			AddToggleOptionST("Feeding_Toggle", "$Milking_H3_S8", MilkQ.Feeding)
			AddToggleOptionST("ForcedFeeding_Toggle", "$Milking_H3_S14", MilkQ.ForcedFeeding)
			AddSliderOptionST("Feeding_Duration_Slider", "$Milking_H3_S9.1", MilkQ.Feeding_Duration, "$Milking_H3_S9.2")
			if MilkQ.Feeding_Sound == 0
				AddTextOptionST("Feeding_Sound_Toggle", "$Milking_H3_S12", "$Milking_H3_S12.1")
			elseif MilkQ.Feeding_Sound == 1
				AddTextOptionST("Feeding_Sound_Toggle", "$Milking_H3_S12", "$Milking_H3_S12.2")
			elseif MilkQ.Feeding_Sound == 2
				AddTextOptionST("Feeding_Sound_Toggle", "$Milking_H3_S12", "$Milking_H3_S12.3")
			endif
			AddToggleOptionST("FuckMachine_Toggle", "$Milking_H3_S10", MilkQ.FuckMachine)
			AddSliderOptionST("FuckMachine_Duration_Slider", "$Milking_H3_S11.1", MilkQ.FuckMachine_Duration, "$Milking_H3_S11.2")

	SetCursorPosition(1)
			AddToggleOptionST("PainSystem_Toggle", "$Milking_Pain_System", MilkQ.PainSystem)
			AddToggleOptionST("PainHurts_Toggle", "$Milking_Pain_Hurts", MilkQ.PainKills)
			AddToggleOptionST("MilkingDrainsSP_Toggle", "$Milking_MilkingDrainsSP", MilkQ.MilkingDrainsSP)
			AddToggleOptionST("MilkingDrainsMP_Toggle", "$Milking_MilkingDrainsMP", MilkQ.MilkingDrainsMP)
			AddEmptyOption()
...
function Market()
	SetCursorFillMode(TOP_TO_BOTTOM)
		AddHeaderOption(MilkQ.MilkE.locWhiterun.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoWhiterun, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandWhiterun], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption(MilkQ.MilkE.locMarkarth.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoMarkarth, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandMarkarth], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption(MilkQ.MilkE.locSolitude.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoSolitude, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandSolitude], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption(MilkQ.MilkE.locDawnstar.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoDawnstar, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandDawnstar], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption(MilkQ.MilkE.locWindhelm.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoWindhelm, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandWindhelm], OPTION_FLAG_DISABLED)

	SetCursorPosition(1)
		AddHeaderOption(MilkQ.MilkE.locRiften.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoRiften, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandRiften], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption(MilkQ.MilkE.locFalkreath.GetName())
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoFalkreath, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandFalkreath], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption("$Milk_Market_Information_Orcish_Strongholds")
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoOrc, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandOrc], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption("$Milk_Market_Information_Khajiit_Caravaneers")
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoCaravan, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandCaravan], OPTION_FLAG_DISABLED)
			AddEmptyOption()
		AddHeaderOption("$Milk_Market_Information_Solstheim")
			AddTextOption("$Milk_Market", MilkQ.MilkE.MilkEcoMorrowind, OPTION_FLAG_DISABLED)
			AddTextOption("$Milk_Market_Demand", RaceMilk[MilkQ.MilkE.MilkDemandMorrowind], OPTION_FLAG_DISABLED)
endfunction
	...
	SetCursorFillMode(TOP_TO_BOTTOM)
		if MilkQ.MilkQC.Debug_enabled
			AddHeaderOption("$Debug_H1")
				AddSliderOptionST("Debug_Mastery_Slider", "$Maid_Mastery_Level", MilkQ.ProgressionLevel)
				AddSliderOptionST("Debug_TimesMilked_Slider", "$Times_Milked_(this_level)", MilkQ.ProgressionTimesMilked)
				AddSliderOptionST("Debug_TimesMilked_Overall_Slider", "$Times_Milked_(overall)", MilkQ.ProgressionTimesMilkedAll)
				;AddToggleOptionST("Debug_Zaz_Milkpump_Toggle", "$Settings_H1_S11", MilkQ.ZazPumps)
				AddToggleOptionST("Debug_PC_Pregnancy_Toggle", "$Settings_H1_S10", MilkQ.PlayerCantBeMilkmaid)
	...
	SetCursorFillMode(TOP_TO_BOTTOM)
		...
		if MilkQ.MilkQC.Debug_enabled
			...
			if MaidlistA[MaidIndex] != none
				ActorAlias = self.GetAlias(MaidIndex) as MME_ActorAlias
	...
	if option == Settings_WeightUpScale_T
		if !MilkQ.WeightUpScale
			...
			int i = 0
				while i < MilkQ.MilkMaid.Length
					if MilkQ.MilkMaid[i] != None
						ActorAlias = self.GetAlias(i) as MME_ActorAlias
...
state Debug_PC_Pregnancy_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H1_S10_Higlight")
	endEvent
endState
...
state MaidLvlCap_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H1_S5_Higlight")
	endEvent
endState
...
state BreastScale_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S6_Higlight")
	endEvent
endState
...
state BreastScaleLimit_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S7_Higlight")
	endEvent
endState
...
state BreastUpScale_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S5_Higlight")
	endEvent
endState
...
state Notification_Messages_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H3_S1_Higlight")
	endEvent
endState
...
state Milk_Count_Notification_Messages_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H3_S7_Higlight")
	endEvent
endState
...
state Notification_Economy_Messages_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H3_S6_Higlight")
	endEvent
endState
...
state Milk_Stories_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Settings_H3_S2_Higlight")
	endEvent
endState
...
state DialogueForceMilkSlave_Toggle
	...
	endEvent
	event OnHighlightST()
		SetInfoText("$Settings_H3_S8_Higlight")
	endEvent
endState
...
state Poll_Interval_Slider
	...
	event OnSliderAcceptST(float value)
		...
		SetSliderOptionValueST(MilkQ.MilkPoll, "$Settings_H1_S2.2")
	endEvent

	event OnHighlightST()
		SetInfoText("$Settings_H1_S2_Higlight")
	endEvent
endState
...
state Difficulty_Menu
	...
	event OnHighlightST()
		SetInfoText("$Settings_H4_S1_Higlight")
	endEvent
endState
...
state BreastScaleMax_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S1_Higlight")
	endEvent
endState
...
state BreastCurve_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S2_Higlight")
	endEvent
endState
...
state BreastIncreasePerLvl_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S4_Higlight")
	endEvent
endState
...
state BreastIncrease_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H2_S3_Higlight")
	endEvent
endState
...
state LactacidDecayRate_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H1_S9_Higlight")
	endEvent
endState
...
state LactacidMod_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H1_S12_Higlight")
	endEvent
endState
...
state MilkGenerationValue_Slider
	...
	event OnSliderAcceptST(float value)
		...
		SetSliderOptionValueST(MilkQ.MilkGenValue, "$Settings_H1_S7.1")
	endEvent

	event OnHighlightST()
		SetInfoText("$Settings_H1_S7_Higlight")
	endEvent
endState
...
state NPCComments_Chance_Slider
	...
	event OnHighlightST()
		SetInfoText("$Settings_H3_S3_Higlight")
	endEvent
endState
...
state PainSystem_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Milking_Pain_System_Higlight")
	endEvent
endState
...
state PainHurts_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Milking_Pain_Hurts_Higlight")
	endEvent
endState
...
state SimpleMilk_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Milking_H3_S13_Higlight")
	endEvent
endState
...
state Milking_MilkWithZaZMoMSuctionCups_Toggle
	event OnSelectST()
		...
		if !MilkQ.MilkNaked && !MilkQ.MilkWithZaZMoMSuctionCups
			...
			toggleVal = "$Milking_H3_S5.1"
		elseif !MilkQ.MilkWithZaZMoMSuctionCups
			MilkQ.MilkNaked = false
			MilkQ.MilkWithZaZMoMSuctionCups = true
			toggleVal = "$Milking_H3_S5.2"
		else
			MilkQ.MilkNaked = false
			MilkQ.MilkWithZaZMoMSuctionCups = false
			toggleVal = "$Milking_H3_S5.3"
		endif
		SetTextOptionValueST(toggleVal)
	endEvent
	
	event OnHighlightST()
		SetInfoText("$Milking_H3_S5_Higlight")
	endEvent
endState
...
state Feeding_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Milking_H3_S8_Higlight")
	endEvent
endState
...
state ForcedFeeding_Toggle
	...
	event OnHighlightST()
		SetInfoText("$Milking_H3_S14_Higlight")
	endEvent
endState
...
state Feeding_Sound_Toggle
	event OnSelectST()
		...
		if MilkQ.Feeding_Sound == 0
			...
			toggleVal = "$Milking_H3_S12.2"
		elseif MilkQ.Feeding_Sound == 1
			MilkQ.Feeding_Sound = 2
			toggleVal = "$Milking_H3_S12.3"
		elseif MilkQ.Feeding_Sound == 2
			MilkQ.Feeding_Sound = 0
			toggleVal = "$Milking_H3_S12.1"
		endif
		SetTextOptionValueST(toggleVal)
	endEvent
endState
...
state Milking_Duration_Slider
	...
	event OnSliderAcceptST(float value)
		...
		SetSliderOptionValueST(MilkQ.Milking_Duration, "$Milking_H3_S7.2")
	endEvent
endState
...
state Milking_GushPct_Slider
	...
	event OnHighlightST()
		SetInfoText("$Milking_H3_S16_Higlight")
	endEvent
endState
...
state Feeding_Duration_Slider
	...
	event OnSliderAcceptST(float value)
		...
		SetSliderOptionValueST(MilkQ.Feeding_Duration, "$Milking_H3_S9.2")
	endEvent

	event OnHighlightST()
		SetInfoText("$Milking_H3_S9_Higlight")
	endEvent
endState
...
state FuckMachine_Duration_Slider
	...
	event OnSliderAcceptST(float value)
		...
		SetSliderOptionValueST(MilkQ.FuckMachine_Duration, "$Milking_H3_S11.2")
	endEvent
endState
